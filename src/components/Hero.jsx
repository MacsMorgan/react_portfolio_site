        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hii there, I'm{" "}
              <p className="name text-[#915EFF]">Michael Shittu</p>
            </h1>
            <h3>
              <span
                ref={textRef}
            ...
            <div className="absolute link1">
              <a href="https://github.com/MacsMorgan" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/michael-shittu-24477a271?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                target="_blank"
              >
                <ImLinkedin />
              </a>
              <a
                href="https://www.instagram.com/macmorgany?igsh=YzljYTk1ODg3Zg=="
                target="_blank"
              >
                <AiOutlineInstagram />
              </a>
